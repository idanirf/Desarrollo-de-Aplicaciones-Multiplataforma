...
class LoggingFragment : Fragment() , MenuProvider{
    ...
    override fun onCreateView(
        ...
        binding.buttonReserbas.setOnClickListener {
            view?.let { Navigation.findNavController(binding.root).navigate(R.id.action_loggingFragment_to_recyclerReserbasUsuariosFragment)}
        }
